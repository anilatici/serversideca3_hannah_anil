            ...
            <div class="w-full px-2 py-4">
                 <div class="flex flex-wrap -mx-2">
                    <div class="w-2/3 px-2">
                        <h1 class="index-heading text-4xl font-bold mb-2">Food!</h1>
                    ...
                    <div class="w-1/3 px-2 flex flex-col items-start">
                        ...
                        <a href="/blog/create/post" class="index-button py-2 px-4 bg-blue-500 text-white text-sm rounded">Add Recipe</a>
                    </div>
                </div>                
